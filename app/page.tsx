...
export default function Home() {
  return (
    <>
      <Background />
      <div className="flex flex-col overflow-hidden items-center min-h-screen justify-between p-8 py-20 gap-16 sm:pt-12 sm:pb-4">
        <main className="flex flex-col gap-8 justify-start items-center">
          ...
          <AnimationContainer className="size-full" delay={0.1}>
            <AddSnippet />
          </AnimationContainer>
          <AnimationContainer className="size-full" delay={0.15}>
            <Link
              href="/snippets"
